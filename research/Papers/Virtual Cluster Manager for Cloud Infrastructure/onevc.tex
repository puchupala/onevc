...
Hirotake Abe\IEEEauthorrefmark{3}, 
Susumu Date\IEEEauthorrefmark{4} and
Shinji Shimojo\IEEEauthorrefmark{5}}
\IEEEauthorblockA{\IEEEauthorrefmark{1}Department of Computer Engineering, 
Kasetsart University, Bangkok, Thailand\\
Email: see http://aosekai.net/about/}
...
Osaka University, Osaka, Japan\\
Email: habe@cmc.osaka-u.ac.jp}
\IEEEauthorblockA{\IEEEauthorrefmark{4}Cybermedia Center, 
Osaka University, Osaka, Japan\\
Email: date@ais.cmc.osaka-u.ac.jp}
\IEEEauthorblockA{\IEEEauthorrefmark{5}Cybermedia Center, 
Osaka University, Osaka, Japan\\
Email: shimojo@cmc.osaka-u.ac.jp}
}
...
There are also a lot of cloud toolkits available to help administrator setup IaaS cloud.
...
This paper describes design and implementation of virtual cluster manager built on top of existing cloud toolkit as well as the case study of virtual cluster deployment in traditional way compare to using this utility.
\end{abstract}
...
With cloud computing\cite{Armbrust:EECS-2009-28} being a buzzword recently, there are wide range of cloud computing toolkits available nowadays.
