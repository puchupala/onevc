...
\caption{OpenNebula software stack (implified)}
\label{fig:onearch}
\end{figure}
...
It works along with other built-in CLI utilities on the same layer and relied on the same Ruby OCA interface.
However, we need to create another table in the database to hold VC information.
